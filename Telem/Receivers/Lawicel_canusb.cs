...
namespace SSCP.Telem.Can {
    class LAWICEL {
        ...
        [DllImport("canusbdrv.dll", EntryPoint = "canusb_ReadFirst")]
        ...
        [DllImport("canusbdrv.dll", EntryPoint = "canusb_SetTimeouts")]
        ...
        [DllImport("canusbdrv.dll", EntryPoint = "canusb_getNextAdapter")]
